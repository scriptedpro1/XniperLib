	...
	function Xniper:CreateTab(options)
		...
		function Tab:Slider(options)
			...
			do 
				...
				Slider["1d"] = Instance.new("Frame", Tab["11"]);
				Slider["1d"]["BorderSizePixel"] = 0;
				Slider["1d"]["BackgroundColor3"] = Color3.fromRGB(36, 36, 36);
				Slider["1d"]["Size"] = UDim2.new(0, 382, 0, 54);
				Slider["1d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				Slider["1d"]["Position"] = UDim2.new(0.009999926201999187, 0, 0.3431819975376129, 0);
				Slider["1d"]["Name"] = [[Slider]];

				-- StarterGui.TabLib.Main.Container.Tab.Slider.UICorner
				Tab["1e"] = Instance.new("UICorner", Slider["1d"]);
				Tab["1e"]["CornerRadius"] = UDim.new(0, 5);

				-- StarterGui.TabLib.Main.Container.Tab.Slider.UIStroke
				Tab["1f"] = Instance.new("UIStroke", Slider["1d"]);
				...
				Tab["20"] = Instance.new("TextLabel", Slider["1d"]);
				...
				Tab["21"] = Instance.new("ImageLabel", Slider["1d"]);
				...
				Tab["22"] = Instance.new("Frame", Slider["1d"]);
				...
				Tab["26"] = Instance.new("TextLabel", Slider["1d"]);
			...
			do
				Slider["1d"].MouseEnter:Connect(function()
					...
					Xniper:tween(Slider["1d"], {BackgroundColor3 = Color3.fromRGB(45,45,45)})
				end)
